...
public  class Withdrawal extends JFrame implements ActionListener
{
		...
		JLabel L1=new JLabel("Withdrawal");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			...
			if(bal<amt)
			{
				JOptionPane.showMessageDialog(null,"Withdrawal amount is greater than balance");
			JOptionPane.showMessageDialog(null,"Balance Amount is "+bal);
				T3.requestFocus();
				return;
			}
		
				int a=rs.getRow();
				int x=stmt.executeUpdate("insert into withdrawal values("+acn+ ",'"+day+"','"+month+"','"+year+"',"+amt+")");
				if(a>0)
				{
